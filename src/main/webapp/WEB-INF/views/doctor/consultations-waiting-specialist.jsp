...
<head>
    ...
    <title>Consultations en Attente de Spécialiste</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-3">
                ...
                <h2 class="text-3xl font-semibold text-gray-900">Consultations en attente de spécialiste</h2>
            </div>
        </div>

        <c:choose>
            <c:when test="${not empty waitingForSpecialist}">
                <!-- Professional Table -->
                    ...
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-8 py-5 text-left text-sm font-semibold text-gray-800">Date consultation</th>
                                <th class="px-8 py-5 text-left text-sm font-semibold text-gray-800">Motif</th>
                                <th class="px-8 py-5 text-left text-sm font-semibold text-gray-800">Diagnostic</th>
                        ...
                        <tbody>
                            <c:forEach var="consultation" items="${waitingForSpecialist}" varStatus="status">
                                <tr class="hover:bg-blue-50/50 transition-colors duration-200 ${status.index % 2 == 0 ? 'bg-white' : 'bg-gray-50/30'}">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <c:if test="${not empty consultation.patient.allergies}">
                                                    <div class="text-xs text-red-600 font-medium">⚠️ Allergies</div>
                                                </c:if>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div>
                                                <span class="text-lg font-medium text-gray-800">${consultation.createdAt.toLocalDate()}</span>
                                    ...
                                    <td class="px-8 py-6">
                                        <div class="max-w-xs">
                                            <p class="text-sm text-gray-900 font-medium">${consultation.chiefComplaint}</p>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <span class="text-sm text-gray-500 italic">En évaluation</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                    <td class="px-8 py-6">
                                        <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-orange-100 text-orange-800 border border-orange-200">
            ...
            <c:otherwise>
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-16 text-center">
                    ...
                    <h3 class="text-xl font-medium text-gray-700 mb-2">Aucune consultation en attente</h3>
                    <p class="text-gray-500">Toutes les consultations ont été traitées ou sont en cours</p>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
