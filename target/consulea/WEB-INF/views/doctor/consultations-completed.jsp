...
<head>
    ...
    <title>Consultations Terminées</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-3">
                ...
                <h2 class="text-3xl font-semibold text-gray-900">Consultations terminées</h2>
            </div>
        </div>

        <c:choose>
            <c:when test="${not empty completedConsultations}">
                <!-- Professional Table -->
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <table class="w-full">
                        ...
                        <tbody>
                            <c:forEach var="consultation" items="${completedConsultations}" varStatus="status">
                                <tr class="hover:bg-blue-50/50 transition-colors duration-200 ${status.index % 2 == 0 ? 'bg-white' : 'bg-gray-50/30'}">
                                    ...
                                    <td class="px-8 py-6">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <span class="text-sm text-gray-500 italic">Non spécifié</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                    <td class="px-8 py-6">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-lg font-medium text-gray-800">${consultation.cost} DH</span>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
            ...
            <c:otherwise>
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-16 text-center">
                    ...
                    <h3 class="text-xl font-medium text-gray-700 mb-2">Aucune consultation terminée</h3>
                    <p class="text-gray-500">Vous n'avez pas encore terminé de consultations</p>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
